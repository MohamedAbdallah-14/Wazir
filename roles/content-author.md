...
All content artifacts must avoid AI vocabulary patterns. The humanizer is an additive layer on top of `expertise/content/foundations/editorial-standards.md`, not a replacement. For domain-specific rules, see `expertise/humanize/domain-rules-content.md`.
