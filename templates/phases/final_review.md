...
- [ ] Use `Skill(wz:compliance-measurement)` — measure pipeline compliance, produce compliance-report.md <!-- 4d -->
- [ ] Extract learnings with adoption rates, quality delta, user corrections <!-- 4e -->
