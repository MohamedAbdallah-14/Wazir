...
## Immediate — Phase A: Restore Stability
- [ ] Preserve research docs (copy out before rollback)
- [ ] Rollback main to 9d0f3b0 (PR #4 — last stable state)
- [ ] Clean up stale branches (keep enforcement-experiments for reference)
- [ ] Verify tests pass + exports build
- [ ] Sync plugin cache with restored skills

## Next — Phase B: Brainstorm
- [ ] Brainstorm enforcement architecture (hooks vs prompts vs hybrid)
- [ ] Decide what to implement first based on research data
- [ ] Write execution plan

## Implementation — Phase C: Hook Enforcement
...
## Implementation — Phase D: Prompt Restructuring
- [ ] Research and apply DeCRIM-style prompt structure (decomposed constraints, not prose)
- [ ] Restructure wazir skill: shorter, explicit numbered constraints, no psychology bloat
...
## Research References
- docs/research/2026-03-23-enforcement-research-synthesis.md — full 7-agent synthesis
