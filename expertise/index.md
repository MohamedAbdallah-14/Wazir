...
## `/humanize` -- AI text humanization and writing quality
...
- `domain-rules-technical-docs.md` -- rules for specs, plans, architecture docs
...
- `self-audit-checklist.md` -- two-pass verification checklist
...
If humanizing text or removing AI writing patterns → read `/humanize/index.md`
