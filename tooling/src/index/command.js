  ...
  try {
    ...
    switch (parsed.subcommand) {
      ...
      case 'search-symbols': {
        ...
        if (!query) {
          return failure('Usage: wazir index search-symbols <query> [--state-root <path>] [--json]');
        }
      ...
      case 'get-symbol': {
        ...
        if (!query) {
          return failure('Usage: wazir index get-symbol <name-or-id> [--state-root <path>] [--json]');
        }
      ...
      case 'get-file-outline': {
        ...
        if (!relativePath) {
          return failure('Usage: wazir index get-file-outline <relative-path> [--state-root <path>] [--json]');
        }
      ...
      default:
        return failure('Usage: wazir index <build|refresh|stats|search-symbols|get-symbol|get-file-outline|summarize> [options]');
    }
  } catch (error) {
